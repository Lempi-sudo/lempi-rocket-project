...
func (x *OrderInfo) GetPaymentMethod() PaymentMethod {
	if x != nil {
...
func (x *PayOrderRequest) GetOrder() *OrderInfo {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *PayOrderResponse) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x05order\x18\x01 \x01(\v2\x15.payment.v1.OrderInfoR\x05order\"&\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBSZQgithub.com/Lempi-sudo/lempi-rocket-project/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
...
var (
	...
	file_payment_v1_payment_proto_goTypes   = []any{
		...
		(*OrderInfo)(nil),        // 1: payment.v1.OrderInfo
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: payment.v1.OrderInfo.payment_method:type_name -> payment.v1.PaymentMethod
	1, // 1: payment.v1.PayOrderRequest.order:type_name -> payment.v1.OrderInfo
	2, // 2: payment.v1.PaymentService.PayOrder:input_type -> payment.v1.PayOrderRequest
